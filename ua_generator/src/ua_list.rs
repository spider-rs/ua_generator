...
pub const STATIC_AGENTS: &'static [&'static str; 9] = &[
    ...
    "Mozilla/5.0 (Windows NT 6.2; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2917.40 Safari/537.36",
    ...
    "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2628.28 Safari/537.36",
    ...
    "Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2915.60 Safari/537.36"
];  
