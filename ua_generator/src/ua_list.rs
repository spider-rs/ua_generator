...
pub const STATIC_AGENTS: &'static [&'static str; 9] = &[
    ...
    "Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/49.0.2640.38 Safari/537.36",
    ...
    "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2739.88 Safari/537.36",
    ...
    "Mozilla/5.0 (X11; Ubuntu; Linux i686 on x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/55.0.2918.80 Safari/537.36"
];  
